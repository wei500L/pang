...
type ConversationStore interface {
	...
	CreateWithMode(owner, title, mode string) (conversations.Conversation, error)
	...
	UpdatePromptContext(owner, id string, update conversations.PromptContextUpdate) (conversations.Conversation, error)
