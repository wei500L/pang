...
const (
	...
	MaxChunkBytes               int64 = 256 << 10
	MaxRecordingBytes                 = 128 << 20
	MaxRecordingChunks                = 14400
	MaxActiveRecordingsPerOwner       = 2
	MaxActiveRecordingsGlobal         = 128
	MaxConcurrentChunkWrites          = 8
	MaxConcurrentAssemblies           = 2
	MinRecordingFreeBytes       int64 = 512 << 20
	MaxSnapshotMessages               = 120
	MaxSnapshotContentChars           = 8192
	staleRecordingAfter               = 30 * time.Minute
